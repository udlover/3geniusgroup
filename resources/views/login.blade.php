...
<head>
        ...
        <!-- Bootstrap -->
        <link href="public/admin_assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <!-- Bootstrap rtl -->
        <!--<link href="admin_assets/bootstrap-rtl/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"/>-->
        <!-- Pe-icon-7-stroke -->
        <link href="public/admin_assets/pe-icon-7-stroke/css/pe-icon-7-stroke.css" rel="stylesheet" type="text/css"/>
        <!-- style css -->
        <link href="public/admin_assets/dist/css/stylecrm.css" rel="stylesheet" type="text/css"/>
        <!-- Theme style rtl -->
    ...
    <body>
        ...
        <!-- /.content-wrapper -->
        <!-- jQuery -->
        <script src="public/admin_assets/plugins/jQuery/jquery-1.12.4.min.js" type="text/javascript"></script>
        <!-- bootstrap js -->
        <script src="public/admin_assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    </body>
